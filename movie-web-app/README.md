...
**Note**: This project was created as part of an academic assignment to demonstrate React.js development, API integration, localStorage usage, and modern web development best practices using TypeScript, Tailwind CSS, and React Router.
